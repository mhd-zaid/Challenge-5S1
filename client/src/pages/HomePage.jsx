    ...
    <>
      ...
      <Box display="flex" flexDirection="column" bg="black" color="white" >
        <Box display="flex" justifyContent="center" alignItems="center" marginTop="6em">
          <Heading fontSize="4xl" fontFamily="Poppins, sans-serif" fontWeight="bold">Découvrez nos chef d'oeuvre</Heading>
        </Box>
        <Box display="flex" marginTop="8em" alignSelf="center" paddingBottom="8em">
          <Slider sliders={sliders} />
        </Box>
      </Box>
      {/* Section 3 */}
      <Box>
        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" marginTop="6em" gap="8">
        ...
        <SimpleGrid columns={2} spacingX="40px" spacingY="20px" margin="10% 10%" fontFamily="Poppins, sans-serif">
          <Box 
            height="sm" 
            bg="gray.300" 
          ...
          >
            ...
            <Text fontSize="md">moins d'oublis avec les rappels sms des rendez-vous</Text>
            <Box className="button" opacity={0} transition="opacity 0.3s">
              <Button bg="black" color="white"
                variant="outline"
                size="sm"
